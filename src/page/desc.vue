	...
	export default{
		...
		methods:{
			toList:function(index){
				...
				this.$router.push({path:'/desc-list'})
			}
		},
		components:{
			Banner
...
.section{
	width: 33.3%;background: url(../../static/img/keshitese.png) no-repeat center/contain;height:8rem;text-align: center;line-height: 8rem;
